...
class WideResNet(nn.Module):
    def __init__(self, depth, num_classes, widen_factor=10, dropRate=0.3, in_channel=3):
...
def wrn28_10(pretrained, num_classes, in_channel):
    model = WideResNet(depth=28, num_classes=num_classes, widen_factor=10, in_channel=in_channel)
    return model
